...
import kotlinx.android.synthetic.main.activity_ubah_pass.btnEditPass
...
class UbahProfilActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val notification = NotificationCompat.Builder(this, CHANNEL_ID)
            .setContentTitle("Notif Ubah Profil")
            .setContentText("Berhasil mengubah profil")
        ...
        ibBackUbahProfil.setOnClickListener{
